...
class GUI_FrameTrapBot(Tk):
    def __init__(self):
        ...
        #self.s = Style()
        #self.s.configure('TNotebook', background='red')
        ...
        self.note.add(self.frame_bot.frame, text = "Frame Trap")
        self.note.add(self.dummy_tab1, text="2")
        self.note.add(self.dummy_tab2, text="3")
        self.note.add(self.dummy_tab3, text="4")
    ...
    def DoStyleNotebook(self):
        ...
        myActiveTabForegroundColor = 'red'
        myTabBackgroundColor = 'black'
        myTabForegroundColor = 'red'
